      ...
      <div className="main-page-container">
        <div className="row">
          ...
          <div className="work-page-container">
            ...
            <div id="infoAndMindmapping" className="row work-tab animate-on-hover">
              <div className="col-sm-12 col-md-3 col-lg-2 text-right pr-4 border-right">
                <h1 className="work-title-icon">
                  <FontAwesomeIcon icon={["fas", "clipboard-list"]} className="text-muted" />
                </h1>
                <h6 className="work-title">
            ...
            <div id="personalityTraits" className="row work-tab animate-on-hover">
              <div className="col-sm-12 col-md-3 col-lg-2 text-right pr-4 border-right">
                <h1 className="work-title-icon">
                  <FontAwesomeIcon icon={["fas", "female"]} className="text-muted" />
                </h1>
                <h6 className="work-title">
                  Personality Traits
                </h6>
