          ...
          <div className="col-xs-12 col-sm-12 col-md-12 col-lg-6 mt-5">
            <div className="row">
              <div className="col-md-12">
                ...
                <p>
                  I am an INFJ <span role="img" aria-label="nerd">🤓</span>, perfectionist <span role="img" aria-label="100">💯</span>, technology geek <span role="img" aria-label="comp">👨‍💻</span>,
                  keen learner <span role="img" aria-label="Snowman">📚</span>, and music enthusiast <span role="img" aria-label="music">🎵</span>. I design products for humankind, which are easy to use, striking an emotional connection, and integral in everyday tasks.
                </p>
              </div>
            </div>
